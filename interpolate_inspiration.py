...
def get_depth_map(image_path, model_path="depth-anything/Depth-Anything-V2-Large-hf"):
...
def process_interpolation(img_a_path, img_b_path, output_frames_folder, num_frames=30, start_index=0, skip_first_frame=False):
    print(">>> [Interpolate] 1. Calcul des Depth Maps...")
    depth_a, img_a_cv = get_depth_map(img_a_path)
    depth_b, img_b_cv = get_depth_map(img_b_path)
